...
description: "Licensed tree service in Waynesboro and Washington Township, PA. Removal, emergency response, trimming, stumps, and lot clearing. Free on-site estimates."
city: "Waynesboro"
state: "PA"
heroImage: "../../assets/images/location-waynesboro.jpg"
heroImageMobile: "../../assets/images/location-waynesboro-mobile.jpg"
...
whyHere:
  ...
  body: |
    Waynesboro properties tend to have serious trees. Tucked against South Mountain, a lot of these lots back up to woods or carry mature hardwoods that have been there far longer than the house — oaks, maples, and tall pines that drop big limbs in the wind that funnels down off the ridge. We work with that: careful removals when a tree genuinely has to come down, honest trimming when it doesn't, and full cleanup that leaves the yard looking like we were never there. Whether you're in the borough, out in Washington Township, or up toward Rouzerville, Quincy, or Blue Ridge Summit, we'll handle it like it's our own.
  quote:
    quote: "Waynesboro's a working town, and people here can tell the difference between a crew that does the job and one that talks about it. We show up when we say we will, we say what we mean on the estimate, and we finish clean. That's the whole pitch."
...
externalLink:
  url: "https://www.waynesboropa.org/"
  text: "Borough of Waynesboro — official government site"
  source: "Borough of Waynesboro, PA"
