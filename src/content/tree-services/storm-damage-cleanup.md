...
description: "Full storm damage cleanup in Hagerstown, Frederick, and Martinsburg — fallen branches, uprooted trees, debris hauling, and site restoration after severe weather."
city: "Hagerstown"
state: "MD"
heroAlt: "Storm damage cleanup crew clearing fallen branches in a Hagerstown neighborhood"
emergency: false
...
signsYouNeed:
  ...
  items:
    ...
    - title: "Split trunks or major limb breaks"
      description: "When a major scaffold limb tears out of the trunk, the wound rarely heals properly. The tree usually has to come down for safety."
    - title: "Debris piled across the yard"
      description: "Wet leaves, limbs, and brush suffocate grass if left in place. Cleanup within a few days protects what's underneath."
...
processSteps:
  heading: "Our Storm Cleanup Process"
  steps:
    - title: "Property walk"
      description: "We walk the lot with you, identify hazards first, and document everything for your records and insurance."
    - title: "Make safe"
      description: "Hanging limbs, leaning trees, and anything over walkways or drives comes down first."
    - title: "Downed tree removal"
      description: "Uprooted and broken trees get cut into manageable sections and removed."
    - title: "Chipping and haul-off"
      description: "Brush is chipped on site when possible. Logs and larger material are loaded out."
    - title: "Final cleanup"
      description: "Raking, blowing, and a walk-through so the yard is usable before we leave."
...
faqs:
  ...
  - question: "Do you work with insurance adjusters?"
    answer: "Yes. We provide photos, a written scope of work, and itemized invoices in the format adjusters expect. If your adjuster wants to see the site before removal, tell us and we'll sequence the work accordingly."

externalLink:
  url: "https://www.weather.gov/stormready/"
  text: "StormReady community preparedness from the National Weather Service"
